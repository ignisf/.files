...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   'gnome
   `(cursor ((,class (:background "#2E3436"))))
   `(border-color ((,class (:background "#EDEDED"))))
   `(vertical-border ((,class (:foreground "#C6C6C6" :background "#EDEDED"))))
   `(default ((,class (:background "#EDEDED" :foreground "#2E3436"))))
   `(fringe ((,class (:background "#EDEDED"))))
   `(mode-line ((,class (:background "#EDEDED" :foreground "#2E3436"
