...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   'gnome
   `(cursor ((,class (:background "#292929"))))
   `(border-color ((,class (:background "#292929"))))
   `(vertical-border ((,class (:foreground "#C6C6C6" :background "#292929"))))
   `(default ((,class (:background "#292929" :foreground "#2E3436"))))
   `(fringe ((,class (:background "#292929"))))
   `(mode-line ((,class (:background "#292929" :foreground "#2E3436"
                                     :box (:line-width -1 :color "#C6C6C6" :style nil)))))
   `(mode-line-inactive ((,class (:foreground "#C6C6C6" :background ,"#EDEDED"
                                              :box (:line-width -1 :color "#C6C6C6" :style nil)))))
   `(header-line ((,class (:foreground "#CCCCCC" :background "black"))))

   `(minibuffer-prompt ((,class (:foreground "#204A87" :bold t))))
   `(region ((,class (:foreground unspecified :background "#C2D5E9"))))
   `(dired-header ((,class (:bold t :foreground "#204A87"))))
   `(widget-button ((,class (:bold t :foreground "#204A87"))))
   ...
   `(web-mode-symbol-face ((,class (:foreground "#A020F0"))))
   `(font-lock-constant-face ((,class (:foreground "#A020F0"))))
   ...
   `(show-paren-match-face ((,class (:foreground unspecified :background "#C2D5E9"))))
   `(show-paren-mismatch-face ((,class (:background "#B50000" :foreground "white"))))
   ...
   `(hl-line ((,class (:background "#DEDEDE"))))
   `(vline ((,class (:background "#DEDEDE"))))
   ...
   `(magit-item-highlight ((,class (:background "#DEDEDE"))))
